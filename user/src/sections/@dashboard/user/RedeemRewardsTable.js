...
const TABLE_HEAD = [
  { id: 'name', label: 'Offer', alignRight: false },
...
export default function RedeemRewardsTable() {
  ...
  return (
    <Page title="Happy Stories">
      <>
        ...
        {/* <Card> */}
        <Box
          sx={{display:'flex', justifyContent:'right', mb:3}}
        >
          <CardHeader title="Your Referral Count: 20" />
        </Box>
